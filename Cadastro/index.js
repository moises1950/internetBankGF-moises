...
const validarSenha = () => {	
  ...
  if (senhaDigitada != confirmacaoDigitada) {
    erros.push("senha");
    document.getElementById("confirmacaoSenhaError").innerHTML = "As senhas não conferem, digite novamente.";
  } else {
...
const validarIdade = () => {
  ...
  if (idadeDigitada < 18) {
    erros.push["idade"]
    document.getElementById("idadeError").innerHTML = "A idade mínima é 18 anos"
  } else {
